...
- 최근 변경: 없음 (v1)
- 마지막 실험: dev EXP-012 LSTM window 24(부모 EXP-011), 시드 0·1·2, val MAE 114.1215±4.4820 / RMSE 157.9242, 조기 종료 32~64에폭. EXP-011(103.0124)보다 10.8% 나쁨, 주말도 더 나빠짐(토 103.9, 일 118.2) → 가설 기각. 긴 창(144)이 하루 중 위치(시각 맥락)를 주는 것으로 추정. dev 최선: ARIMA EXP-009(93.8156), LSTM EXP-011(103.0124)

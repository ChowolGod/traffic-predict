...
- 최근 변경: 없음 (v1)
- 마지막 실험: dev EXP-011 LSTM max_epochs 100(부모 EXP-010), 시드 0·1·2, val MAE 103.0124±2.3310 / RMSE 145.6739, 조기 종료 57~76에폭. 처음 50에폭 곡선이 EXP-010과 1e-12 이내 동일(재현성 확인). 평일은 ARIMA와 같거나 나음(목 94.4, 금 119.7), 주말은 여전히 약함(토 94.8, 일 103.1). dev 최선은 ARIMA EXP-009(93.8156)

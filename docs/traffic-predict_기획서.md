...
- 최근 변경: 없음 (v1)
- 마지막 실험: dev sweep(부모 EXP-003, arima.order) → EXP-007 (1,1,1) 98.3630 / EXP-008 (3,1,3) 95.1271 / EXP-009 (5,1,5) 93.8156. EXP-003(94.1631) 대비 -0.4%~+4.5%: 차수 영향 작음. dev ARIMA 최선: EXP-009(차이는 작음)

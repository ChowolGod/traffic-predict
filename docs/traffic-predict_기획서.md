...
- 최근 변경: 없음 (v1)
- 마지막 실험: dev EXP-010 LSTM 초기 설정(부모 EXP-001, changed model.type), 시드 0·1·2, val MAE 107.4369±1.6576 / RMSE 150.2999±2.2700, 48초. best epoch 47~50/50(끝까지 아주 조금씩 개선). 금요일은 최선(121.6), 주말은 lag-1보다 나쁨(토 99.7, 일 108.3). dev 최선은 여전히 ARIMA EXP-009(93.8156)

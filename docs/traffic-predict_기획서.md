...
- 최근 변경: 없음 (v1)
- 마지막 실험: dev EXP-006 ARIMA(2,0,2) diff144(부모 EXP-004, changed arima.order) val MAE 142.3831 — EXP-004(142.4173)와 거의 같음. AR 합 0.982로 d=0에서도 단위근에 가깝게 적합 → 과차분 가설 기각. 계절 차분 계열 자체가 지속성이 강함. 현재 dev 최선: EXP-003(94.1631)

...
| 25 | F-09 개정 | (v2.12) M-14(final.yaml 거리 단계·lag-1008, 두 기준 구간, 시드별 절대오차, 결정 지표, 켜기/끄기), M-12(공용 계산 함수) / 테스트(픽스처: 새 형식 결과 표·검증·원자성·재학습 없음·F-11) | 진행 중 | 2026-09-23 사용자 결정. 실제 test 실행(12)은 "설정 동결, test 실행" 지시 후 |

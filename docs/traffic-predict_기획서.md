...
| M-19 | (v2.10) `eval/switching.py: simulate(y_true, y_pred, imputed, thr, horizon, hold_min, on_ratio, delay_min)`, `switching_metrics(...)`, `choose_r1(rows)` | 3.3 켜기/끄기 시뮬레이션: 칸별 켜짐 상태, 지표, 기준선, r1 선택 | D-07 + θ → D-16 | M-18 |
...
| 23 | F-14 | (v2.10) M-19, M-15(`switching` 키 검증), M-12(D-16 표) / 테스트(손계산 예제, 3단계 경보와 일치, r1, 시드 평균, E-2001, 재학습 없음) | 대기 | 2026-09-23 사용자 승인 |
